...
def write_summary_report(report_dir: Path, summaries: List[CaseSummary],
    ...
    lines = ["# HW13 Judge Summary", "", f"- total cases: {len(summaries)}",
...
class HW13JudgeWindow(StandardJudgeWindow):
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        spec = StandardJudgeSpec(
            ...
            title='OO HW13 评测机',
            base_dir=base_dir,
            self_work_dir=(base_dir.parents[2] / 'U4/hw13').resolve(),
            official_default=(base_dir / 'lib/library1.jar').resolve(),
            fixed_cases_dirname='fixed_cases_hw13',
...
def build_page(parent: QWidget) -> QWidget:
    return build_standard_page(HW13JudgeWindow, parent)
