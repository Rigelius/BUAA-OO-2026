...
from .engine import (
    ...
    discover_projects,
    normalize_events,
    parse_input_requests_v2 as parse_input_requests,
    run_java_command_v2 as run_java_command,
    run_target_case,
    write_problem_case,
...
class HW5JudgeWindow(StandardJudgeWindow):
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        spec = StandardJudgeSpec(
            ...
            title='OO HW5 评测机',
            base_dir=base_dir,
            self_work_dir=(base_dir.parents[2] / 'U2/hw5').resolve(),
            official_default=(base_dir / 'lib/elevator1-2026.jar').resolve(),
...
def build_page(parent: QWidget) -> QWidget:
    return build_standard_page(HW5JudgeWindow, parent)
