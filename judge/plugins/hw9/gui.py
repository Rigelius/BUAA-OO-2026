...
class HW9JudgeWindow(StandardJudgeWindow):
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        spec = StandardJudgeSpec(
            ...
            title='OO HW9 评测机',
            base_dir=base_dir,
            self_work_dir=(base_dir.parents[2] / 'U3/hw9').resolve(),
...
def build_page(parent: QWidget) -> QWidget:
    return build_standard_page(HW9JudgeWindow, parent)
