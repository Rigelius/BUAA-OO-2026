...
class HW6JudgeWindow(StandardJudgeWindow):
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        spec = StandardJudgeSpec(
            ...
            title='OO HW6 评测机',
            base_dir=base_dir,
            self_work_dir=(base_dir.parents[2] / 'U2/hw6').resolve(),
            official_default=(base_dir / 'lib/elevator2-2026.jar').resolve(),
...
def build_page(parent: QWidget) -> QWidget:
    return build_standard_page(HW6JudgeWindow, parent)
