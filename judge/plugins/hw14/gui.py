...
def write_summary_report(report_dir: Path, summaries: List[CaseSummary],
    ...
    lines = ["# HW14 Judge Summary", "", f"- total cases: {len(summaries)}",
...
class HW14JudgeWindow(StandardJudgeWindow):
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        spec = StandardJudgeSpec(
            ...
            title='OO HW14 评测机',
            base_dir=base_dir,
            self_work_dir=(base_dir.parents[2] / 'U4/hw14').resolve(),
            official_default=(base_dir / 'lib/library2.jar').resolve(),
            fixed_cases_dirname='fixed_cases_hw14',
...
def build_page(parent: QWidget) -> QWidget:
    return build_standard_page(HW14JudgeWindow, parent)
